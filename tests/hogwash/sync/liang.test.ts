...
import { loadPack } from '../../../skills/hogwash/scripts/rules/schema.js'
import { importLiangTables, LIANG_ORIGIN } from '../../../skills/hogwash/scripts/sync/liang.js'

const tables = readFileSync('skills/hogwash/data/liang-2024-tables.tsv', 'utf8')
const packText = readFileSync('tests/hogwash/fixtures/sync/liang-pack.json', 'utf8')
const packs = [loadPack(JSON.parse(packText), 'tests/hogwash/fixtures/sync/liang-pack.json')]
