...
import { loadPack, type Rule, RuleSchema } from '../../../skills/hogwash/scripts/rules/schema.js'
import { applyEdits } from '../../../skills/hogwash/scripts/sync/apply.js'
import type { AcceptedEdit } from '../../../skills/hogwash/scripts/sync/review.js'
import { RuleIdSchema } from '../../../skills/hogwash/scripts/types.js'

const origin = 'rules/claudisms.json'
const current = readFileSync(new URL('../fixtures/sync/pack-apply.json', import.meta.url), 'utf8')
