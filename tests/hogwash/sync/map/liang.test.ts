...
import {
  ...
  liangWeight,
  mapLiangTables,
} from '../../../../skills/hogwash/scripts/sync/map/liang.js'

const sample = readFileSync(
  new URL('../../fixtures/sync/liang-sample.tsv', import.meta.url),
  'utf8',
)
const tables = readFileSync(
  new URL('../../../../skills/hogwash/data/liang-2024-tables.tsv', import.meta.url),
  'utf8',
)
